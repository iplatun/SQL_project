CREATE TABLE "CUSTOMER_INFO" (
  ...
  "SECONDARY_INCOME" DECIMAL(12,4) NULL,
   CREATE [UNIQUE] INDEX CUSTOMERINFO
...
CREATE TABLE "EMPLOYEES" (
  ...
  "OFFICERID" NUMBER(10) NOT NULL,
  "IDENTIFIERID" NUMBER(10) NOT NULL,
  "FIRST_NAME" VARCHAR2(100) NOT NULL,
  "LAST_NAME" VARCHAR2(100) NOT NULL,
...
CREATE TABLE "" (
  "LOCATIONID" NUMBER(10) NOT NULL PRIMARY KEY ,
  "TOWNSHIP" VARCHAR2(10) NOT NULL,
...
CREATE TABLE "SURVEYREQUEST" (
  ...
  "RESTAKE" NUMBER(10) NOT NULL,
  "NAMEDEVELOP" VARCHAR2(50) NOT NULL,
  "REQUESTDATE" TIMESTAMP NOT NULL,
  "REQUESTBY" VARCHAR2(50) NOT NULL,
  "COMPLETEDATE" TIMESTAMP NOT NULL,
  "CONTRACTDATE" TIMESTAMP NOT NULL, 
CONSTRAINT SURVEY_LOCATION_FK 
FOREIGN KEY (LOCATIONID)
REFERENCES LOCATION (LOCATIONID)
CONSTRAINT SURVEY_CLIENT_FK 
...
CREATE TABLE "TASKS" (
  "TASKID" NUMBER(10) NOT NULL PRIMARY KEY,
  "JOBID" NUMBER(10) NOT NULL,
  "TASKNOTES" VARCHAR2(100) NOT NULL,
  "TASKDESCR" VARCHAR2(100) NOT NULL,
  "IS_DRAWING_AVAILABLE" NUMBER(0,1) NOT NULL,
CONSTRAINT SURVEY_TASKS_FK 
FOREIGN KEY (JOBID)
REFERENCES SURVEYREQUEST (JOBID)
ON UPDATE CASCADE
);

CREATE TABLE "CREW" (
  "CREWID" NUMBER(10) NOT NULL PRIMARY KEY,
  "CREWCODE" NUMBER(10) NOT NULL,
);

CREATE TABLE "EMPLOYEE" (
  "EMPLID" NUMBER(10) NOT NULL PRIMARY KEY,
  "CREWID" NUMBER(10) NOT NULL,
  "FIRSTNAME" VARCHAR2(50) NOT NULL,
  "LASTNAME" VARCHAR2(50) NOT NULL,
CONSTRAINT EMPLOYEE_CREW_FK 
FOREIGN KEY (CREWID)
...
CREATE TABLE "FIELDWORK" (
  "FIELDWORKID" NUMBER(10) NOT NULL PRIMARY KEY,
  "BOOKID" NUMBER(10) NOT NULL,
  "COMPLETED" TIMESTAMP NOT NULL,
  "BEGINPAGE" NUMBER(10) NOT NULL,
);

CREATE TABLE "SCHEDULEFORM" (
  "SCHEDULEFORMID" NUMBER(10) NOT NULL PRIMARY KEY,
  "FIELDWORKID" NUMBER(10) NOT NULL,
  "EMPID" NUMBER(10) NOT NULL,
  "TASKID" NUMBER(10) NOT NULL,
  "WORKDATE" TIMESTAMP NOT NULL,
  "DATESCHEDULED" TIMESTAMP NOT NULL,
  "NOTES" VARCHAR2(100) NOT NULL,
CONSTRAINT SCHEDULEFORM_FIELDWORK_FK
FOREIGN KEY (FIELDWORKID) 
REFERENCES  FIELDWORK (FIELDWORKID)
CONSTRAINT SCHEDULEFORM_EMPLOYEE_FK
FOREIGN KEY (EMPLID)
REFERENCES  EMPLOYEE (EMPID)
CONSTRAINT SCHEDULEFORM_TASKS_FK
FOREIGN KEY (TASKID)
...
CREATE TABLE "SCHEDULE_FIELDWORK" (
  "SCHEDULEFORMID" NUMBER(10) NOT NULL,
  "FIELDWORKID" NUMBER(10) NOT NULL,
CONSTRAINT SCHEDULE_SCHEDULEFORMID_FK
FOREIGN KEY (SCHEDULEFORMID)
REFERENCES  SCHEDULEFORM (SCHEDULEFORMID)
CONSTRAINT SCHEDULE_FIELDWORK_FK
FOREIGN KEY (FIELDWORKID)
REFERENCES  FIELDWORK (FIELDWORKID)
);
